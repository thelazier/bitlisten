...
StatusBox.connected = function(type) {
	if (type == "blockchain")
		StatusBox.blockchain.html('Transactions (insight.masternode.io:3000): <span style="color: green;">' + CONNECTED + '</span>');
	if (type == "mtgox")
...
StatusBox.reconnecting = function(type) {
	if (type == "blockchain")
		StatusBox.blockchain.html('Transactions (insight.masternode.io:3000): <span style="color: yellow;">' + CONNECTING + '</span>');
	if (type == "mtgox")
...
StatusBox.nosupport = function(type) {
	if (type == "blockchain")
		StatusBox.blockchain.html('Transactions (insight.masternode.io:3000): <span style="color: red;">' + NO_SUPPORT + '</span>');
	if (type == "mtgox")
...
StatusBox.closed = function(type) {
	if (type == "blockchain")
		StatusBox.blockchain.html('Transactions (insight.masternode.io:3000): <span style="color: gray;">' + CLOSED + '</span>');
	if (type == "mtgox")
